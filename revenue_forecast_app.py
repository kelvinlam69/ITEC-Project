...
def forecast_revenue(df, periods=4):
    df = df.copy()
    df = df.dropna(subset=['CPI', 'marketing_spend'])
...
- Model: ARIMAX with CPI and Marketing Spend
...
# Merge or update CPI column with fresh data
